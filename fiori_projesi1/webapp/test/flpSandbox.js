		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#fioriprojesi1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"fioriprojesi1-display": {
								"semanticObject": "fioriprojesi1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=fioriprojesi1",
									"url": sap.ui.require.toUrl("fioriprojesi1")
								}
							}
						}
					}
